...
import os
import polars as pl
from art_e.evaluate.load_trajectories import load_trajectories, pull_model_trajectories
from art_e.evaluate.charts import comparison_models_bar_chart, training_progress_chart
from all_models import models

# %%

await pull_model_trajectories(models["207"])  # type: ignore
await pull_model_trajectories(models["205"])  # type: ignore
