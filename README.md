...
| **Codenames**     | [🏋️ Train agent](https://colab.research.google.com/github/openpipe/art/blob/add_codenames_nb/examples/codenames/Codenames_RL.ipynb)     | Qwen 2.5 3B learns to play Codenames    | <img src="/assets/benchmarks/codenames/win_rate_over_time.png" height="72"> [benchmarks](/examples/codenames/Codenames_RL.ipynb) |
